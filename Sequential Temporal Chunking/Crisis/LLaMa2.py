...
#"egypt",
stories = ["egypt","libya", "syria", "yemen"]
datasetpath = "/Dataset/Crisis/"

for k in range(len(stories)):
    path = datasetpath + "llama2-clusters-summary" +stories[k] + ".csv"
    ...
    clustfileSummary = "llama2-clusters-summary10" + stories[k] + ".csv"
    ...
    filepathV2 = "llama2-clusters-summary20" + stories[k] + ".csv"
    ...
    opath = datasetpath + stories[k] + "/outputTimelines.csv"
    ...
    ppath  = datasetpath + stories[k] + "/outputTimelinesData.csv"
